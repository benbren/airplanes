...
The Shiny application can be viewed by running this command on the ```R``` console: . It is important to note that the ```shiny``` package must be first insalled before this app can be run. We provide an illustration of what the dashboard looks like below.
